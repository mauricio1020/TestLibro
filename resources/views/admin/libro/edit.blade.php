...
@section('content')
    ...
    <div class="container text-center">
        ...
        <div class="page-header">
            <h1>
                <i class="fa fa-shopping-cart"></i> Libros <small>[ Editar libro]</small>
            </h1>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="page">
                    ...
                    {!! Form::model($libro, array('route' => array('libro.update', $libro->id))) !!}

                    <input type="hidden" name="_method" value="PUT">
                    <div class="form-group">
                        <label class="" for="editoriales_id">Editorial</label>
